                    ...
                    <div className="flex justify-center">
                        <div className="w-[620px] bg-black border border-purple-600 p-6 rounded-lg shadow-lg text-center">
                            ...
                            <div className="space-y-4">
                                ...
                                <br />
                                <br />
                                <Link href="/week-10/shopping-list" className="inline-block rounded-lg border border-purple-600 bg-purple-900/30 p-4 font-semibold transition hover:bg-purple-700 hover:text-black">
                                    Go to Shopping List
                                </Link>
                            </div>
                        )}
